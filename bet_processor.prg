...
DO WHILE (.NOT.EOF()) && Поки не настане кінець файлу
	...
	IF (id_re_b = id_re_e) THEN && Є виграш чи ні й нарахування відповідної суми виграшу
	...
	IF (summ_bet_now >= 1000) THEN && Перевірка на можливість виплати певної суми
	...
	IF (id_re_b = id_re_e) THEN && Є виграш чи ні й нарахування капіталу відділу
		IF ( (capital_departament_now - summ_bet_now) < 1000) THEN && Перевірка на існування капіталу відділу
